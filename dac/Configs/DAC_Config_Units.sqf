...
// Russia (EMR) (RHS) (OPFOR)
	case 12:
		{
			_Unit_Pool_S = ["rhs_msv_emr_combatcrew", "rhs_pilot", "rhs_msv_emr_sergeant", "rhs_msv_emr_rifleman", "rhs_msv_emr_rifleman", "rhs_msv_emr_rifleman", "rhs_msv_emr_grenadier_rpg", "rhs_msv_emr_grenadier", "rhs_msv_emr_machinegunner"];
			_Unit_Pool_V = ["rhs_tigr_m_3camo_msv","rhs_tigr_3camo_msv"];
...
// ChDKZ (GREF) (OPFOR)
	case 15:
		{
			_Unit_Pool_S = ["rhsgref_ins_rifleman" , "rhsgref_ins_rifleman" , "rhsgref_ins_squadleader" , "rhsgref_ins_rifleman" , "rhsgref_ins_rifleman" , "rhsgref_ins_rifleman" , "rhsgref_ins_rifleman_akm" , "rhsgref_ins_grenadier" , "rhsgref_ins_machinegunner" , "rhsgref_ins_grenadier_rpg" ];
			_Unit_Pool_V = [];
			_Unit_Pool_T = [];
			_Unit_Pool_A = [];
		};
...
//CSAT - Pacific
	case 32:
		{
			_Unit_Pool_S = ["O_T_Soldier_F","O_T_Pilot_F","O_T_Soldier_TL_F","O_T_Soldier_AAA_F","O_T_Soldier_AAT_F","O_T_Soldier_AR_F","O_T_Medic_F","O_T_Engineer_F","O_T_Soldier_Exp_F","O_T_Soldier_GL_F","O_T_Soldier_M_F","O_T_Soldier_AA_F","O_T_Soldier_AT_F","O_T_Officer_F","O_T_Soldier_PG_F","O_T_Soldier_Repair_F","O_T_Soldier_F","O_T_Soldier_LAT_F","O_T_Soldier_SL_F","O_T_Soldier_TL_F","O_T_Soldier_UAV_F"];
			...
			_Unit_Pool_T = ["O_T_APC_Tracked_02_cannon_ghex_F","O_T_APC_Wheeled_02_rcws_ghex_F","O_T_MBT_02_cannon_ghex_F"];
...
//Syndikat - Pacific
	case 33:
		{
			_Unit_Pool_S = ["I_C_Soldier_Bandit_4_F","I_C_Soldier_Bandit_3_F","I_C_Soldier_Bandit_7_F","I_C_Soldier_Bandit_5_F","I_C_Soldier_Bandit_6_F","I_C_Soldier_Bandit_2_F","I_C_Soldier_Bandit_8_F","I_C_Soldier_Bandit_1_F","I_C_Soldier_Para_2_F","I_C_Soldier_Para_4_F","I_C_Soldier_Para_6_F","I_C_Soldier_Para_1_F","I_C_Soldier_Para_7_F","I_C_Soldier_Para_5_F","I_C_Soldier_Para_8_F","I_C_Soldier_Para_3_F"];
			_Unit_Pool_V = ["I_C_Offroad_02_unarmed_F","I_C_Van_01_transport_F","I_G_Offroad_01_armed_F","I_G_Offroad_01_F","I_G_Van_01_transport_F"];
			_Unit_Pool_T = [];
			_Unit_Pool_A = ["I_C_Heli_Light_01_civil_F"];
		};
//-------------------------------------------------------------------------------------------------
//NATO - Pacific
	case 34:
		{
			_Unit_Pool_S = ["B_T_Soldier_AA_F","B_T_Soldier_AA_F","B_T_Soldier_AAA_F","B_T_Soldier_AT_F","B_T_Soldier_AT_F","B_T_Soldier_AAT_F","B_T_Soldier_SL_F","B_T_Soldier_F","B_T_Soldier_LAT_F","B_T_soldier_M_F","B_T_Soldier_TL_F","B_T_Soldier_AR_F","B_T_Soldier_A_F","B_T_Medic_F"];
			...
			_Unit_Pool_T = ["B_T_MBT_01_TUSK_F","B_T_MBT_01_cannon_F","B_T_APC_Wheeled_01_cannon_F","B_T_APC_Tracked_01_rcws_F","B_T_MBT_01_mlrs_F","B_T_MBT_01_arty_F"];
			_Unit_Pool_A = ["B_T_VTOL_01_armed_F","B_T_VTOL_01_infantry_F"];
		};
